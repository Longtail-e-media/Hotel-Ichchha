...
const Gallery = () => {
  const { data: galleryImages, loading, error } = useFetchApi(
    "https://hotelichchha.com/api/api_gallery.php",
    "galleryImages"
  );
    ...
    <section className="bg-bg-gold-light">
      ...
      <section className="py-8 md:pt-0 md:pb-20">
        <ScrollReveal
          ...
          para="Immerse yourself in luxury, comfort, and personalized service. From elegant rooms to impeccable amenities, discover hospitality at its finest. Elevate your stay with us. Welcome to a world of unparalleled indulgence."
          textColor="text-navy"
